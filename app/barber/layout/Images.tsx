...
export default function Images() {
    ...
    return (
        <div className="w-full relative" ref={ref}>
            ...
            <motion.div 
                className='w-[90%]  xl:h-[80vh] z-10 rounded-2xl outline outline-[#0c54315e] border-3 border-[#041507] bg-white absolute bottom-10 md:-bottom-10 left-1/2 overflow-hidden' 
                style={{ y: divY, x: "-50%" }}
            >
