...
export default function TextureButton() {
  return (
    ...
    className='bg-[url("/bg.png")] bg-cover bg-center bg-no-repeat w-fit rounded-2xl p-1 ring-1 ring-white shadow-xl shadow-black/20 cursor-pointer group scale-75 md:scale-0'>
